...
public class MainWindow extends javax.swing.JFrame {
    ...
    public MainWindow() throws ClassNotFoundException, SQLException {
        ...
        rs = c.buscar("SELECT * FROM archivos ORDER BY id DESC LIMIT 1");
        initComponents();
        if(rs.next()){
            jTextField1.setText(rs.getString("name"));
            jTextField2.setText(rs.getString("size"));
            jTextField3.setText(rs.getString("updated_at"));
            jTextField4.setText(rs.getString("owner"));
        }
        else{
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Size of the file:");

        jLabel3.setText("Last modification:");

        jLabel4.setText("File Owner: ");

        jLabel5.setText("Universidad Politécnica de Chiapas");

        jLabel6.setText("Software engineering");

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/concurrentfinalproject/logo.png"))); // NOI18N

        jLabel8.setText("Concurrent Programming");

        jLabel9.setText("Linux Programming");

        jLabel10.setText("Marcos Uriel Hernández Camacho");

        jLabel11.setText("Jorge Fernando Palacios de los Santos");
